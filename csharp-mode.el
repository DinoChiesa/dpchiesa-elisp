...
;;
;;    0.8.6 DPC 2011 May ??
;;          - extern and fixed are now treated as keywords
;;
...
"
  ...
  ("xmls" "{
      ...
      s1.Serialize(new XTWFND(Console.Out), object, ns);
      Console.WriteLine(\"\\n\");
}
  ...
  /// usage:       s1.Serialize(new XTWFND(Console.Out), thing, ns);
...
" "xmlserializer { ... }" nil)
  ("wl" "Console.WriteLine(${0://thing to do});
" "WriteLine( ... );" nil)
  ...
  ("setting" " #region Property${1:PropName}
    ...
    public string $1
    {
        get
        {
                if (_$1 == null)
                {
                    _$1 = Configuration.ConfigurationManager.AppSettings[\"$1\"];
...
$0" "XML Documentation" nil)
  ...
  var foo = Values.ConvertAll((s) => { return Convert.ToInt32(s); }) ;
...
[assembly: AssemblyCopyright(\"Copyright (c) ${4:Someone} 2011\")]
